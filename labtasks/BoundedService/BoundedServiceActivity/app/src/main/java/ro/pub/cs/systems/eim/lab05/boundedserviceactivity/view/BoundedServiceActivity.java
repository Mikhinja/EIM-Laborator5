...
public class BoundedServiceActivity extends AppCompatActivity {
    ...
    // : exercise 10e - implement a button click listener for getMessageFromServiceButton
    private class GetMessageFromServiceButtonListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (boundedService != null && boundedServiceStatus == Constants.SERVICE_STATUS_BOUND) {
                messageFromServiceTextView.setText(
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // : exercise 10e - set an instance of the button click listener to handle click events
    ...
    protected void onStart() {
        super.onStart();
        // : exercise 10d - bind the service through an intent
        Intent bindActivityToServiceIntent = new Intent(this, BoundedService.class);
        bindService(bindActivityToServiceIntent, serviceConnection, Context.BIND_AUTO_CREATE);
    }

    @Override
    protected  void onStop() {
        // : exercise 10d - unbind the service
        super.onStop();
        if (boundedServiceStatus == Constants.SERVICE_STATUS_BOUND) {
            unbindService(serviceConnection);
            //boundedServiceStatus = Constants.SERVICE_STATUS_UNBOUND; // is this really needed?
        }
    }

    // : exercise 10c - create a ServiceConnection object
